...
describe('Orders', () => {
  ...
  describe('GET /orders/ordered - ADMIN ONLY', () => {
      ...
      const cb = () => {
        ...
        agent
          ...
          .then((res) => {
            ...
            // trying to get quoted orders as newClientUser
            chai.request(app)
              .get(`/orders/ordered/?userId=${userId}&userRole=${userRole}`)
              .end((err, res) => {
          ...
          .then((res) => {
            ...
            chai.request(app)
              ...
              .end((err, res) => {
                ...
                orders.should.be.a('array');
                expect(orders.length).to.equal(1);
                expect(orders[0].id).to.equal(newOrderedOrder.id);
                expect(orders[0].shipping_address).to.equal(newOrderedOrder.shipping_address);
                expect(orders[0].shipping_city).to.equal(newOrderedOrder.shipping_city);
                expect(orders[0].shipping_state).to.equal(newOrderedOrder.shipping_state);
                expect(orders[0].shipping_zip).to.equal(newOrderedOrder.shipping_zip);
                expect(orders[0].po_number).to.equal(newOrderedOrder.
                  po_number);
                expect(orders[0].UserId).to.equal(newOrderedOrder.UserId);
                
                // Order_Details
                expect(orders[0].Order_Details).to.be.a('array');
                expect(orders[0].Order_Details.length).to.equal(1);
                expect(orders[0].Order_Details[0].machine_serial_num).to.equal(newOrderedOrderDetail.machine_serial_num);
                expect(orders[0].Order_Details[0].quantity).to.equal(newOrderedOrderDetail.quantity);
                expect(orders[0].Order_Details[0].price).to.equal(newOrderedOrderDetail.price);
                expect(orders[0].Order_Details[0].Part).to.be.a('object');
                expect(orders[0].Order_Details[0].Part.number).to.equal(newPart.number);
                expect(orders[0].Order_Details[0].Part.description).to.equal(newPart.description);
                expect(orders[0].Order_Details[0].Part.cost).to.equal(newPart.cost);
                ...
                expect(orders[0].Order_Statuses.length).to.equal(1);
                expect(orders[0].Order_Statuses[0].current).to.equal(
                  newOrderedOrderStatus.current);
                expect(orders[0].Order_Statuses[0].StatusTypeId).to.equal(newOrderedOrderStatus.StatusTypeId);
  ...
  describe('GET /orders/shipped - ADMIN ONLY', () => {
      ...
      const cb = () => {
        ...
        agent
          ...
          .then((res) => {
            ...
            // trying to get quoted orders as newClientUser
            chai.request(app)
              .get(`/orders/shipped/?userId=${userId}&userRole=${userRole}`)
              .end((err, res) => {
          ...
          .then((res) => {
            ...
            chai.request(app)
              ...
              .end((err, res) => {
                ...
                orders.should.be.a('array');
                expect(orders.length).to.equal(1);
                expect(orders[0].id).to.equal(newShippedOrder.id);
                expect(orders[0].shipping_address).to.equal(newShippedOrder.shipping_address);
                expect(orders[0].shipping_city).to.equal(newShippedOrder.shipping_city);
                expect(orders[0].shipping_state).to.equal(newShippedOrder.shipping_state);
                expect(orders[0].shipping_zip).to.equal(newShippedOrder.shipping_zip);
                expect(orders[0].po_number).to.equal(newShippedOrder.
                  po_number);
                expect(orders[0].UserId).to.equal(newShippedOrder.UserId);
                
                // Order_Details
                expect(orders[0].Order_Details).to.be.a('array');
                expect(orders[0].Order_Details.length).to.equal(1);
                expect(orders[0].Order_Details[0].machine_serial_num).to.equal(newShippedOrderDetail.machine_serial_num);
                expect(orders[0].Order_Details[0].quantity).to.equal(newShippedOrderDetail.quantity);
                expect(orders[0].Order_Details[0].price).to.equal(newShippedOrderDetail.price);
                expect(orders[0].Order_Details[0].Part).to.be.a('object');
                expect(orders[0].Order_Details[0].Part.number).to.equal(newPart.number);
                expect(orders[0].Order_Details[0].Part.description).to.equal(newPart.description);
                expect(orders[0].Order_Details[0].Part.cost).to.equal(newPart.cost);
                ...
                expect(orders[0].Order_Statuses.length).to.equal(1);
                expect(orders[0].Order_Statuses[0].current).to.equal(
                  newShippedOrderStatus.current);
                expect(orders[0].Order_Statuses[0].StatusTypeId).to.equal(newShippedOrderStatus.StatusTypeId);
  ...
  describe('GET /orders/archived - ADMIN ONLY', () => {
      ...
      const cb = () => {
        ...
        agent
          ...
          .then((res) => {
            ...
            // trying to get quoted orders as newClientUser
            chai.request(app)
              .get(`/orders/archived/?userId=${userId}&userRole=${userRole}`)
              .end((err, res) => {
          ...
          .then((res) => {
            ...
            chai.request(app)
              ...
              .end((err, res) => {
                ...
                orders.should.be.a('array');
                expect(orders.length).to.equal(1);
                expect(orders[0].id).to.equal(newArchivedOrder.id);
                expect(orders[0].shipping_address).to.equal(newArchivedOrder.shipping_address);
                expect(orders[0].shipping_city).to.equal(newArchivedOrder.shipping_city);
                expect(orders[0].shipping_state).to.equal(newArchivedOrder.shipping_state);
                expect(orders[0].shipping_zip).to.equal(newArchivedOrder.shipping_zip);
                expect(orders[0].po_number).to.equal(newArchivedOrder.
                  po_number);
                expect(orders[0].UserId).to.equal(newArchivedOrder.UserId);
                
                // Order_Details
                expect(orders[0].Order_Details).to.be.a('array');
                expect(orders[0].Order_Details.length).to.equal(1);
                expect(orders[0].Order_Details[0].machine_serial_num).to.equal(newArchivedOrderDetail.machine_serial_num);
                expect(orders[0].Order_Details[0].quantity).to.equal(newArchivedOrderDetail.quantity);
                expect(orders[0].Order_Details[0].price).to.equal(newArchivedOrderDetail.price);
                expect(orders[0].Order_Details[0].Part).to.be.a('object');
                expect(orders[0].Order_Details[0].Part.number).to.equal(newPart.number);
                expect(orders[0].Order_Details[0].Part.description).to.equal(newPart.description);
                expect(orders[0].Order_Details[0].Part.cost).to.equal(newPart.cost);
                ...
                expect(orders[0].Order_Statuses.length).to.equal(1);
                expect(orders[0].Order_Statuses[0].current).to.equal(
                  newArchivedOrderStatus.current);
                expect(orders[0].Order_Statuses[0].StatusTypeId).to.equal(newArchivedOrderStatus.StatusTypeId);
  ...
  describe('GET /orders/abandoned - ADMIN ONLY', () => {
      ...
      const cb = () => {
        ...
        agent
          ...
          .then((res) => {
            ...
            // trying to get quoted orders as newClientUser
            chai.request(app)
              .get(`/orders/abandoned/?userId=${userId}&userRole=${userRole}`)
              .end((err, res) => {
          ...
          .then((res) => {
            ...
            chai.request(app)
              ...
              .end((err, res) => {
                ...
                orders.should.be.a('array');
                expect(orders.length).to.equal(1);
                expect(orders[0].id).to.equal(newAbandonedOrder.id);
                expect(orders[0].shipping_address).to.equal(newAbandonedOrder.shipping_address);
                expect(orders[0].shipping_city).to.equal(newAbandonedOrder.shipping_city);
                expect(orders[0].shipping_state).to.equal(newAbandonedOrder.shipping_state);
                expect(orders[0].shipping_zip).to.equal(newAbandonedOrder.shipping_zip);
                expect(orders[0].po_number).to.equal(newAbandonedOrder.
                  po_number);
                expect(orders[0].UserId).to.equal(newAbandonedOrder.UserId);
                
                // Order_Details
                expect(orders[0].Order_Details).to.be.a('array');
                expect(orders[0].Order_Details.length).to.equal(1);
                expect(orders[0].Order_Details[0].machine_serial_num).to.equal(newAbandonedOrderDetail.machine_serial_num);
                expect(orders[0].Order_Details[0].quantity).to.equal(newAbandonedOrderDetail.quantity);
                expect(orders[0].Order_Details[0].price).to.equal(newAbandonedOrderDetail.price);
                expect(orders[0].Order_Details[0].Part).to.be.a('object');
                expect(orders[0].Order_Details[0].Part.number).to.equal(newPart.number);
                expect(orders[0].Order_Details[0].Part.description).to.equal(newPart.description);
                expect(orders[0].Order_Details[0].Part.cost).to.equal(newPart.cost);
                ...
                expect(orders[0].Order_Statuses.length).to.equal(1);
                expect(orders[0].Order_Statuses[0].current).to.equal(
                  newAbandonedOrderStatus.current);
                expect(orders[0].Order_Statuses[0].StatusTypeId).to.equal(newAbandonedOrderStatus.StatusTypeId);
